...
(async function() {
    ...
    // ========================================
    // ChatGPT-ステップ0-3: 統一ChatGPTRetryManager クラス定義
        ...
        async executeWithEscalation(config) {
            ...
            while (retryCount < 20) { // 最大20回
                try {
                    ...
                    console.log(`🔄 [ChatGPT-Retry] ${actionName} 試行 ${retryCount}/20`);
                    ...
                    if (isSuccess(lastResult)) {
                        ...
                        console.log(`✅ [ChatGPT-Retry] ${actionName} 成功（${retryCount}回目）`);
                        return {
                            success: true,
                            result: lastResult,
                            retryCount,
                    ...
                    console.error(`❌ [ChatGPT-Retry] ${actionName} エラー (${retryCount}回目):`, {
                        errorType,
            ...
            // 全リトライ失敗
            console.error(`❌ [ChatGPT-Retry] ${actionName} 全リトライ失敗`);
            return {
                success: false,
                result: lastResult,
                error: lastError,
